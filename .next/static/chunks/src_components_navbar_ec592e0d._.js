...
function TerminalScreen(terminalScreenProps) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useEffect({
        "TerminalScreen.useEffect": ()=>{
            const handler = {
                "TerminalScreen.useEffect.handler": (e)=>{
                    const customEvent = e;
                    terminalScreenProps.setLogs({
                        "TerminalScreen.useEffect.handler": (prevLogs)=>[
                                ...prevLogs,
                                {
                    ...
                    }["TerminalScreen.useEffect.handler"]);
                }
            }["TerminalScreen.useEffect.handler"];
            window.addEventListener("terminal-log", handler);
            return ({
                "TerminalScreen.useEffect": ()=>window.removeEventListener("terminal-log", handler)
            })["TerminalScreen.useEffect"];
        }
    }["TerminalScreen.useEffect"], []);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(TerminalScreen, "3ubReDTFssvu4DHeldAg55cW/CI=");
_c = TerminalScreen;
var _c;
...
function Terminal(param) {
    ...
    const [logs, setLogs] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useState([]);
    const tabs = [
        "PROBLEMS",
        "TERMINAL",
        " OUTPUT"
...
_s(Terminal, "t8GR7PuRMNOAr0F3MXz0ySJOcRc=");
_c = Terminal;
...
//# sourceMappingURL=src_components_navbar_ec592e0d._.js.map