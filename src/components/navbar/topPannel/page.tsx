...
function TopPannel() {
  ...
  return (
    <div className="flex flex-col w-screen bg-bg absolute  rounded-t-xl  shadow-xs shadow-bg">
      <div className="w-screen flex justify-between items-center align-middle  mt-1.5 z-20 border-b-[0.1px] border-secondary-bg pb-1">
        ...
        <div className="w-16 h-5 mr-4 flex justify-between items-center">
          <div
            onClick={() => {
